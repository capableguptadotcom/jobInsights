...
**Observed:** baseline 2026-08-09; refreshed 2026-09-15 (America/Los_Angeles)
...
## Refresh log — 2026-09-15

- Added four live A-tier observations: Nurix AI's Bengaluru AI/ML Engineer (4+ years; multilingual ASR/TTS, agentic RAG, evaluation, and low-latency deployment), Real's India-remote Senior MLE (5+ years; LLM products and agentic production systems), Nunchux AI's San Francisco hybrid visual-generative-model MLE, and Capable Labs' San Francisco MLE for biomolecular-model tooling. [Nurix](https://jobs.ashbyhq.com/Meraki-Labs/b666a64a-24d8-4231-a75d-892f94ebb0ac), [Real](https://jobs.ashbyhq.com/real/d36a6c61-ff2d-4530-bcb7-f3cead4b2bac/), [Nunchux](https://jobs.ashbyhq.com/nunchux/0398a75c-75fe-427a-8d1b-dd0e70b830ea), [Capable](https://jobs.ashbyhq.com/capable/06bf1e55-a317-462a-872d-472caef579ab)
- Added Capable's employer-published process: application, two phone screens, then an in-person San Francisco work trial. No previously tracked role met the evidence threshold for a new closure in this run.
- Rechecked the ten live California roles and their role-level visa language. Nunchux and Capable newly join Composite, zaimler, and Retell in explicitly naming H-1B without limiting the wording to transfers. Reka, Mercator, and Stand remain transfer-only; Poesis remains conditional; Yutori's two roles and Apiphany remain route-unspecified. Employer language still does not establish whether a new cap-subject petition is available, so recruiters must confirm the exact requisition.
- The sample is now 55 job observations, 28 A-tier (50.9%), and 8 interview observations. Speech and real-time inference add a second India-side example, while visual-model post-training and biotech extend the California sample; neither movement has three-snapshot support, so no durable skill trend is declared. The DOL now publishes FY2026 Q3 LCA disclosure data; the tracker retains the DOL-worksite/USCIS-petitioner-geography distinction.
...
For reproducible ingestion, use the official [FY2026 Q3 LCA workbook](https://www.dol.gov/media/LCA_Dislclosure_Data_FY2026_Q3.xlsx), its [record layout](https://www.dol.gov/sites/dolgov/files/ETA/oflc/pdfs/FY26Q3/LCA_Record_Layout_FY2026_Q3.pdf), and the separate [worksites workbook](https://www.dol.gov/media/LCA_Worksites_FY2026_Q3.xlsx). Filter `VISA_CLASS` to H-1B because the disclosure program also contains H-1B1 and E-3. Retain new/continued/change-employer fields, DBA and NAICS, secondary-entity fields, wage/prevailing-wage/level fields, and intended dates.
...
**Current time-sensitive caveat:** rechecked 2026-09-15, the White House proclamation effective 2025-09-21 restricts entry for certain H-1B beneficiaries outside the United States unless the petition is accompanied or supplemented by a $100,000 payment, subject to stated exceptions. Its published text says the restriction expires 12 months after its effective date absent extension; no extension was located in the official proclamation index during this refresh. Add `covers_current_h1b_proclamation_payment = yes/no/unknown`, ask the recruiter directly, and re-check official guidance before every update—especially around 2026-09-21. This is a monitoring flag, not legal advice. [White House proclamation](https://www.whitehouse.gov/presidential-actions/2025/09/restriction-on-entry-of-certain-nonimmigrant-workers/)
